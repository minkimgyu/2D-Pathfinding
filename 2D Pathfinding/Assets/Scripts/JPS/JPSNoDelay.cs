...
namespace JPS
{
    public class JPSNoDelay : MonoBehaviour
    {
        ...
        void Jump(Node targetNode, Node endNode)
        {
            ...
            UpdateJumpPoints(Move(Way.UpStraight, directions[Way.UpStraight], endNode), targetNode, endNode);
            UpdateJumpPoints(Move(Way.RightStraight, directions[Way.RightStraight], endNode), targetNode, endNode);
            UpdateJumpPoints(Move(Way.DownStraight, directions[Way.DownStraight], endNode), targetNode, endNode);
            UpdateJumpPoints(Move(Way.LeftStraight, directions[Way.LeftStraight], endNode), targetNode, endNode);

            UpdateJumpPoints(Move(Way.UpLeftDiagonal, directions[Way.UpLeftDiagonal], endNode), targetNode, endNode);
            UpdateJumpPoints(Move(Way.UpRightDiagonal, directions[Way.UpRightDiagonal], endNode), targetNode, endNode);
            UpdateJumpPoints(Move(Way.DownRightDiagonal, directions[Way.DownRightDiagonal], endNode), targetNode, endNode);
            UpdateJumpPoints(Move(Way.DownLeftDiagonal, directions[Way.DownLeftDiagonal], endNode), targetNode, endNode);
        }
        ...
        Node Move(Way way, Node node, Node endNode)
        {
            switch (way)
            {
                case Way.UpStraight:
